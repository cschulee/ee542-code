# ADNS-9800 Laser Motion Sensor Class
# Author: David Li <Davecyli@gmail.com>, Chris Schulenberg <christopher.s.schuelnberg@gmail.com>
...
class adns9800:
    ...
    firmware = [0x03, 0xa4, 0x6e, 0x16, 0x6d, 0x89, 0x3e, 0xfe, 0x5f, 0x1c, 0xb8, 0xf2, 0x47, 0x0c, 0x7b,
    ...
    def __init__():
        ...
        self.xydat = [0,0]
        self.sensor = spidev.SpiDev(0,1)
        self.sensor.bits_per_word = 8
        self.sensor.mode = 0b11
    ...
    def opticalISR(channel):
        ...
        self.prev_data = [now,deltaX,deltaY]
